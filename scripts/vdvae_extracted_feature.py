...
H, preprocess_fn = set_up_data(H)  # cho H đi qua hàm set_up_data

print('Models is Loading')
ema_vae = load_vaes(H) # model đi qua hàm load_vaes
...
class batch_generator_external_images(Dataset):
    ...
    def __init__(self, data_path):
        ...
        self.im = self.im[:len(self.im) // 5]  # Chỉ lấy 1/7 dữ liệu
...
print("Dữ liệu train và test được chia 1/7 thành công.")
num_latents = 31
...
np.savez("D:/BrainToImage/data/extracted_features/subj{:02d}/nsd_vdvae_features_31l.npz".format(sub),train_latents=train_latents,test_latents=test_latents)
